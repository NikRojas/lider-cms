  ...
  <div>
        ...
        <div class="header-body">
          <div class="row align-items-center pt-0 pt-md-2 pb-4">
            <div class="col-6 col-md-7">
              <BreadCrumb title="Tipo Seguros" parent="Administración" active="Tipo Seguros"></BreadCrumb>
            </div>
            <div class="col-6 col-md-5 text-right">
              <a href="#" class="btn btn-icon btn-inverse-primary" @click.prevent="newEl">
                ...
                <span class="btn-inner--text">Nuevo Tipo de Seguro</span>
              </a>
            </div>
          </div>
        </div>
    ...
    >
      <template slot="modal-title">
        <div class="text-primary h2">{{ title }} Tipo de Seguro</div>
      </template>
