...
class BlueprintsController extends Controller
{
  ...
  public function index($element,$subelement)
  {
    $project = Project::where('slug_es', $element)->firstOrFail();
    $element = ProjectTypeDepartment::where('slug', $subelement)->where('project_id',$project->id)->firstOrFail();
    return view("pages.projects.blueprints.index", compact('element','project'));
  }
