        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Título ES:</label>
                  <p>{{ element.title_es }}</p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Título EN:</label>
                  <p>{{ element.title_en }}</p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Seo keywords ES:</label>
                  <p>{{ element.seo_keywords_es }}</p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Seo Keywords EN:</label>
                  <p>{{ element.seo_keywords_en }}</p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Tags ES:</label>
                  <p>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Tags EN:</label>
                  <p>
                    <template v-for="(tag,i) in element.tags">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Categoría ES:</label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Categoría EN:</label>
                  <template v-if="element.category">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Descripción ES:</label>
                  <p>{{ element.excerpt_es }}</p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Descripción EN:</label>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Contenido ES:</label>
                  <p v-html="element.content_es"></p>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Contenido EN:</label>
          ...
          <div class="col-12 col-lg-4 col-md-4">
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Imagen:</label>
                  <img
              ...
              <div class="col-12">
                <div class="form-group">
                  <label class="font-weight-bold" for="name">Miniatura:</label>
                  <img
