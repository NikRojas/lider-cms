...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getSapDepartments: function getSapDepartments() {
      ...
      axios.get(this.routeGetSap, {
        params: {
          project_id: this.project.id
        }
      }).then(function (response) {
        _this.requestServerSincronization = false;

        _this.getEls(1, _this.elementsPerPage);
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-12 col-lg-2" }, [
      ...
      _vm._v(" "),
      _c("p", [_vm._v("Realiza la sincronización de inmuebles con SAP.")])
    ])
  }
]
render._withStripped = true
