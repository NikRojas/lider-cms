...
class ConnectionController extends BaseController
{
    ...
    public function availableSap($code){
        ...
        try {
            ...
            $sendToView = Department::where('id',$update->id)->load('projectRel:id,logo_colour,price_separation,name_es,name_en,code_ubigeo,project_status_id,master_currency_id,reservation_in_package,package_description');
