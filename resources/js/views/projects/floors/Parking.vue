  ...
  <div>
        ...
        <div class="header-body">
          <div class="row align-items-center pt-0 pt-md-2 pb-3">
            <div class="col-6 col-md-7">
              <BreadCrumb
                :title="'Pisos de Estacionamientos Proyecto ' + project.name_es"
                parent
                active="Proyectos"
              ></BreadCrumb>
            </div>
            <div class="col-6 col-md text-right">
              ...
              >
                <span class="btn-inner--icon">
                  <jam-car class="current-color" />
                </span>
                <span class="btn-inner--text">Nuevo Piso Estacionamiento</span>
              </a>
            </div>
          </div>
          <div class="row mb-3">
    ...
    >
      <template slot="modal-title">
        <div class="text-primary h2">{{ title }} Piso de Estacionamientos</div>
      </template>
      ...
      <div v-else>
        <form @submit.prevent="submit">
          <div class="row">
            ...
            <div class="col-12">
              <ParkingWarehouse :selected.sync="element.estates" :selectedParent="element.estates" :elements="estates.parking"/>
              <label
...
export default {
  ...
  methods: {
    ...
    handleChange(elements) {
      axios
        .put(
          //this.routeOrder+'/'+this.elementParent.id+'/parking',
          this.routeOrder,
          elements
        )
        .then((response) => {
