<template>
  <div class="row mb-4">
    <div class="col-12 col-lg-3">
      ...
      <p>
        Registra las opciones de financiamiento con la que cuentan los Proyectos, las opciones habilitadas se mostrarán en el <b>email de cotización que se envia al Cliente</b>.
      </p>
    </div>
    <div class="col-12 col-lg-9">
              ...
              <div class="text-right">
                ...
                <span class="btn-inner--text">Nueva Opción de Financiamiento</span>
              </a>
              </div>
      <DataTableDraggable
    ...
    >
      <template slot="modal-title">
        <div class="text-primary h2">{{ title }} Opción de Financiamiento</div>
      </template>
