<template>
  <div>
        ...
        <div class="header-body">
          <div class="row align-items-center pt-0 pt-md-2 pb-4">
            <div class="col-6 col-md-7">
              <BreadCrumb title="Miembros" parent="Contenido" active="Información General"></BreadCrumb>
            </div>
            <div class="col-6 col-md-5 text-right">
              <a href="#" class="btn btn-icon btn-inverse-primary" @click.prevent="newEl">
                ...
                <span class="btn-inner--text">Nuevo Miembro de</span>
              </a>
            </div>
          </div>
        </div>
    ...
    >
      <template slot="modal-title">
        <div class="text-primary h2">{{ title }} Miembro de</div>
      </template>
              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col text-center" v-if="element.image">
                    <img
                      :src="imagesUrl+'/members/'+element.image"
                      height="75"
                      :alt="element.name_es"
                    />
                  </div>
