  ...
  <div class="row mb-4">
    ...
    <div class="col-12 col-lg-9">
              ...
              <div class="text-right">
                ...
                <span class="btn-inner--text">Nueva Pestaña</span>
              </a>
              </div>
      <DataTableDraggable
    ...
    >
      <template slot="modal-title">
        <div class="text-primary h2">{{ title }} Pestaña</div>
      </template>
...
export default {
  ...
  methods: {
    ...
    handleChange(elements) {
      axios
        .put('informacion-cotizar/navs/order', elements)
        .then((response) => {
          this.restore();
          Swal.fire({
            title: response.data.title,
    ...
    destroyConfirm() {
      this.requestSubmit = true;
      axios
        .delete('informacion-cotizar/navs/delete/'+ this.element.id)
        .then((response) => {
          this.requestSubmit = false;
          this.restore();
          Swal.fire({
    ...
    getEl(id) {
      ...
      axios
        .get("informacion-cotizar/navs/json/get/" + id)
        .then((response) => {
