...
class GeneralInformationController extends Controller
{
    ...
    public function membersGetAll(Request $request)
    {
        ...
        foreach ($elements as $element) {
            ...
            $image_advisory = config('services.images_url') . "/members/" . $element["image_advisory"];
            $data[] = array(
                "id" => $element["id"],
                "name" => $element["name"],
    ...
    public function certificationsGetAll(Request $request)
    {
        ...
        foreach ($elements as $element) {
            ...
            $image_advisory = config('services.images_url') . "/certifications/" . $element["image_advisory"];
            $data[] = array(
                "id" => $element["id"],
                "name" => $element["name"],
