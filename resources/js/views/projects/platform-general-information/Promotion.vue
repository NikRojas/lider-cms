  ...
  <div class="row mb-5">
    ...
    <div class="col-12 col-lg-9">
      <div class="text-right mb-3">
        ...
        >
          ...
          <span class="btn-inner--text">Nueva Promoción</span>
        </a>
      </div>
      <DataTableDraggable
        ...
        @edit="editEl"
        @delete="deleteEl"
        :message-order="messageOrderPromotion"
      ></DataTableDraggable>
    </div>
    <b-modal
    ...
    >
      <template slot="modal-title">
        <div class="text-primary h2">{{ title }} Promoción</div>
      </template>
...
export default {
  ...
  methods: {
    ...
    orderElements(elements) {
      axios
        .put(this.routeOrderPromotion, elements)
        .then((response) => {
          this.restore();
          Swal.fire({
            title: response.data.title,
    ...
    destroyConfirm() {
      this.requestSubmit = true;
      axios
        .delete(this.routePromotion + "/" + this.element.id)
        .then((response) => {
          this.restore();
          Swal.fire({
            title: response.data.title,
    ...
    getEl(id) {
      ...
      axios
        .get(this.routePromotion + "/json/get/" + id)
        .then((response) => {
