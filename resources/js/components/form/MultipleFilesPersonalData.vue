      ...
      <draggable @change="handleEnd" class="row" v-model="files">
        <div class="col-12" v-for="(el, i) in files" :key="i">
          <div class="row position-relative">
            <div class="position-absolute" style="height: 100%; display: flex; align-items: center; justify-content: center;
    left: 20px;">
            ...
            <div class="col-10 pl-4">
              <div class="row pl-5 pr-3 pl-lg-3 pr-lg-0">
              ...
              <div class="col-12 col-lg-6">
                <div class="form-group">
                  ...
                  <small class="d-block mb-0 lh-1">Formato: PDF</small>
                  <small class="d-block mb-2 lh-1">Tamaño recomendado: No mayor a 35mb</small>
                  <!--<img
