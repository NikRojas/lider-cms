(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/pages/administration/status-project~js/pages/administration/types~js/pages/administration/views~j~07ac14c6"],{
      ...
      if (this.object.data) {
        ...
        for (var key_object in object) {
          ...
          for (var key_element in object_2) {
            if (key_element != "id" && key_element != "action" && key_element != "can_delete") {
